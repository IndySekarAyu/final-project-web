        ...
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ url('panel/kursuseditsimpan/' . $row->idkursus) }}"
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <select name="idguru" id="idguru" class="form-control">
                                            ...
                                            @foreach ($guru as $value)
                                                <option value="{{ $value->idguru }}"
                                                    {{ $value->idguru == $row->idguru ? 'selected' : '' }}>
                                                    {{ $value->namaguru }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input type="text" class="form-control" name="namakursus"
                                            value="{{ $row->namakursus }}" required>
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label class="col-sm-12 col-md-2 col-form-label">Deskripsi Kursus</label>
                                    <div class="col-sm-12 col-md-10">
                                        <textarea rows="5" class="form-control" name="deskripsikursus" required>{{ $row->deskripsikursus }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input type="date" class="form-control" name="tanggalawal"
                                            value="{{ $row->tanggalawal }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-10">
                                        <input type="date" class="form-control" name="tanggalakhir"
                                            value="{{ $row->tanggalakhir }}" required>
                                    </div>
                                </div>
